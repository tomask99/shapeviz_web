...
export function createCrm({api,notify}) {
  ...
  async function detail(id) {
    ...
    try {
      ...
      const createDeck=document.createElement('button');createDeck.className='secondary';createDeck.textContent='Prepare presentation';createDeck.disabled=!!c.archived_at;createDeck.onclick=()=>document.dispatchEvent(new CustomEvent('crm-create-presentation',{detail:{companyId:c.id}}));root.querySelector('.page-heading .actions').append(createDeck);
